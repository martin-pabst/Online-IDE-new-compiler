...
export class WorkspaceImporterMessages {
    static importWorkspace = () => lm({
        'de': 'Workspace importieren',
        'en': 'Import workspace'
    });
    ...
    static importWorkspaceDescription = () => lm({
        'de': "Bitte klicken Sie auf den Button 'Datei auswählen...' oder ziehen Sie eine Datei auf das gestrichelt umrahmte Feld.",
        'en': "Use button 'Choose file...' or drop file on dotted rectangle."
    });

    static pathDescription1 = () => lm({
        'de': 'Dieser Workspace wird auf oberster Ebene in die Workspaceliste kopiert.',
        'en': 'This workspace gets copied into topmost folder.'
    });

    static pathDescription2 = (folder: string) => lm({
        'de': 'Dieser Workspace wird in den Ordner ' + folder + " importiert.",
        'en': 'This workspaces gets copied into folder ' + folder
    });
    ...
    static theseWorkspacesGetImported = () => lm({
        'de': 'Diese Workspaces werden importiert:',
        'en': 'These workspaces get imported:'
    });
