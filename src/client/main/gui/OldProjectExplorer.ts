...
//                 that.main.networkManager.sendDeleteWorkspaceOrFileAsync("file", file.id, (error: string) => {
//                     if (error == null) {
...
//                 that.main.networkManager.sendDeleteWorkspaceOrFileAsync("workspace", workspace.id, (error: string) => {
//                     if (error == null) {
...
//                             downloadFile(await WorkspaceExporter.exportFolder(ws, this.workspaceListPanel), name + ".json")
//                         }
//                     }
//                 );
//             } else {
