...
export class NiedersachsenDynArrayClass extends ObjectClass implements BaseListType {
    static __javaDeclarations: LibraryDeclarations = [
        ...
        { type: "method", signature: "boolean append(Object x)", native: NiedersachsenDynArrayClass.prototype._append, comment: NiedersachsenLang.dynArrayAppendComment },
        { type: "method", signature: "boolean insertAt(int index, Object x)", native: NiedersachsenDynArrayClass.prototype._insertAt, comment: NiedersachsenLang.dynArrayInsertAtComment },
