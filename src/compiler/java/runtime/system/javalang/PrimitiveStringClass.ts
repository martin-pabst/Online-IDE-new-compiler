...
export class PrimitiveStringClass extends ObjectClass {
    ...
    static __javaDeclarations: LibraryDeclarations = [
        ...
        {type: "method", signature: "public final boolean matches(string regex)", template: "(new RegExp('^(?:' + §2 + ')$').test(§1))", constantFoldingFunction: (obj, target) => (obj.match(new RegExp(target, 'g')) != null)},
