...
export class Matrix4Class extends ObjectClass {
    static __javaDeclarations: LibraryDeclarations = [
        ...
        { type: "method", signature: "Matrix4 copyFrom(Matrix4 m)", native: Matrix4Class.prototype._copyFrom, comment: JRC.Matrix4CopyFromComment }, // Spellcheck RESOLVED: method used to be called "copyFropm"
