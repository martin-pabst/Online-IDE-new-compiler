...
export class Matrix4Class extends ObjectClass {
    static __javaDeclarations: LibraryDeclarations = [
        ...
        { type: "method", signature: "Matrix4 copyFrom(Matrix4 m)", native: Matrix4Class.prototype._copyFrom, comment: JRC.Matrix4CopyFromComment }, // Spellcheck RESOLVED: "copyFropm" should be "copyFrom", but changing it would break existing code -> better to take that risk than to keep the typo
