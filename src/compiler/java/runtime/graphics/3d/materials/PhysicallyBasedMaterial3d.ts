...
export class PhysicallyBasedMaterial3dClass extends Material3dClass {
    static __javaDeclarations: LibraryDeclarations = [
        ...
        { type: "method", signature: "PhysicallyBasedMaterial3d(int color, double roughness, double metalness)", native: PhysicallyBasedMaterial3dClass.prototype._physicallyBasedMaterialConstructor, comment: JRC.physicallyBasedMaterial3dConstructorComment }, // Spellcheck RESOLVED: "roughness" used to be called "routhness", no code is broken by changing it because it's only a parameter identifier
        { type: "method", signature: "PhysicallyBasedMaterial3d(string color, double roughness, double metalness)", native: PhysicallyBasedMaterial3dClass.prototype._physicallyBasedMaterialConstructor, comment: JRC.physicallyBasedMaterial3dConstructorComment }, // Spellcheck RESOLVED: "roughness" used to be called "routhness"
        { type: "method", signature: "PhysicallyBasedMaterial3d(Color color, double roughness, double metalness)", native: PhysicallyBasedMaterial3dClass.prototype._physicallyBasedMaterialConstructor, comment: JRC.physicallyBasedMaterial3dConstructorComment }, // Spellcheck RESOLVED: "roughness" used to be called "routhness"
