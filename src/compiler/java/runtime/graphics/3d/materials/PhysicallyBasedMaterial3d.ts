...
export class PhysicallyBasedMaterial3dClass extends Material3dClass {
    static __javaDeclarations: LibraryDeclarations = [
        ...
        { type: "method", signature: "PhysicallyBasedMaterial3d(int color, double routhness, double metalness)", native: PhysicallyBasedMaterial3dClass.prototype._physicallyBasedMaterialConstructor, comment: JRC.physicallyBasedMaterial3dConstructorComment }, // Spellcheck TODO: "routhness" should be "roughness", but changing it would break existing code
        { type: "method", signature: "PhysicallyBasedMaterial3d(string color, double routhness, double metalness)", native: PhysicallyBasedMaterial3dClass.prototype._physicallyBasedMaterialConstructor, comment: JRC.physicallyBasedMaterial3dConstructorComment }, // Spellcheck TODO: "routhness" should be "roughness", but changing it would break existing code
        { type: "method", signature: "PhysicallyBasedMaterial3d(Color color, double routhness, double metalness)", native: PhysicallyBasedMaterial3dClass.prototype._physicallyBasedMaterialConstructor, comment: JRC.physicallyBasedMaterial3dConstructorComment }, // Spellcheck TODO: "routhness" should be "roughness", but changing it would break existing code
