...
export class FilledShapeClass extends ShapeClass {
    static __javaDeclarations: LibraryDeclarations = [
        ...
        { type: "method", signature: "int getFillColorAsInt()", native: FilledShapeClass.prototype._getFillColorAsInt , comment: JRC.fsGetFillColorAsIntComment},
        ...
        { type: "method", signature: "final This setFillColor(int color, double alpha)", native: FilledShapeClass.prototype._setFillColorIntDouble , comment: JRC.fsSetFillColorCommentIntDouble},
        { type: "method", signature: "final This setFillColor(string color)", native: FilledShapeClass.prototype._setFillColorString , comment: JRC.fsSetFillColorCommentString},
        { type: "method", signature: "final This setFillColor(string color, double alpha)", native: FilledShapeClass.prototype._setFillColorStringDouble , comment: JRC.fsSetFillColorCommentStringDouble},
        ...
        { type: "method", signature: "final This setBorderColor(Color color)", native: FilledShapeClass.prototype._setBorderColorColor , comment: JRC.fsSetBorderColorCommentColor},
        { type: "method", signature: "final This setBorderColor(Color color, double alpha)", native: FilledShapeClass.prototype._setBorderColorColor , comment: JRC.fsSetBorderColorCommentColor},
        { type: "method", signature: "final This setBorderColor(int color)", native: FilledShapeClass.prototype._setBorderColorInt , comment: JRC.fsSetBorderColorCommentInt},
        { type: "method", signature: "final This setBorderColor(int color, double alpha)", native: FilledShapeClass.prototype._setBorderColorIntDouble , comment: JRC.fsSetBorderColorCommentIntDouble},
        { type: "method", signature: "final This setBorderColor(string color)", native: FilledShapeClass.prototype._setBorderColorString , comment: JRC.fsSetBorderColorCommentString},
        { type: "method", signature: "final This setBorderColor(string color, double alpha)", native: FilledShapeClass.prototype._setBorderColorStringDouble , comment: JRC.fsSetBorderColorCommentStringDouble},
        { type: "method", signature: "final This setBorderWidth(double width)", native: FilledShapeClass.prototype._setBorderWidth , comment: JRC.fsSetBorderWidthComment},
        ...
        { type: "method", signature: "final This setAlpha(double alpha)", native: FilledShapeClass.prototype._setAlpha , comment: JRC.fsSetAlphaComment},
