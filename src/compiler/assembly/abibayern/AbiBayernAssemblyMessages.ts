...
export class AbiBayernAssemblyMessages {
    ...
    static LoadImmediate = () => lm({
        'de': `load zahl: lädt die Zahl number in den Akkumulator.`,
        'en': `load number: loads the number into the accumulator.`,
        'fr': `load nombre : charge le nombre dans l'accumulateur.`
    });

    static AddImmediate = () => lm({
        'de': `add zahl: addiert die Zahl number zum Akkumulator und speichert das Ergebnis im Akkumulator.`,
        'en': `add number: adds the number to the accumulator and stores the result in the accumulator.`,
        'fr': `add nombre : ajoute le nombre à l'accumulateur et stocke le résultat dans l'accumulateur.`
    });

    static SubImmediate = () => lm({
        'de': `sub zahl: subtrahiert die Zahl number vom Akkumulator und speichert das Ergebnis im Akkumulator.`,
        'en': `sub number: subtracts the number from the accumulator and stores the result in the accumulator.`,
        'fr': `sub nombre : soustrait le nombre de l'accumulateur et stocke le résultat dans l'accumulateur.`
    });

    static MulImmediate = () => lm({
        'de': `mul zahl: multipliziert die Zahl number mit dem Akkumulator und speichert das Ergebnis im Akkumulator.`,
        'en': `mul number: multiplies the number with the accumulator and stores the result in the accumulator.`,
        'fr': `mul nombre : multiplie le nombre avec l'accumulateur et stocke le résultat dans l'accumulateur.`
    });

    static DivImmediate = () => lm({
        'de': `div zahl: dividiert den Akkumulator durch die Zahl number und speichert das Ergebnis im Akkumulator (ganzzahliger Quotient).`,
        'en': `div number: divides the accumulator by the number and stores the result in the accumulator (integer quotient).`,
        'fr': `div nombre : divise l'accumulateur par le nombre et stocke le résultat dans l'accumulateur (quotient entier).`
    });

    static ModImmediate = () => lm({
        'de': `mod zahl: dividiert den Akkumulator durch die Zahl number und speichert den Rest der Division im Akkumulator.`,
        'en': `mod number: divides the accumulator by the number and stores the remainder of the division in the accumulator.`,
        'fr': `mod nombre : divise l'accumulateur par le nombre et stocke le reste de la division dans l'accumulateur.`
    });

    static AndImmediate = () => lm({
        'de': `and zahl: führt eine bitweise Und-Verknüpfung zwischen dem Akkumulator und der Zahl number durch und speichert das Ergebnis im Akkumulator.`,
        'en': `and number: performs a bitwise AND operation between the accumulator and the number and stores the result in the accumulator.`,
        'fr': `and nombre : effectue une opération ET binaire entre l'accumulateur et le nombre et stocke le résultat dans l'accumulateur.`
    });

    static OrImmediate = () => lm({
        'de': `or zahl: führt eine bitweise Oder-Verknüpfung zwischen dem Akkumulator und der Zahl number durch und speichert das Ergebnis im Akkumulator.`,
        'en': `or number: performs a bitwise OR operation between the accumulator and the number and stores the result in the accumulator.`,
        'fr': `or nombre : effectue une opération OU binaire entre l'accumulateur et le nombre et stocke le résultat dans l'accumulateur.`
    });

    static XorImmediate = () => lm({
        'de': `xor zahl: führt eine bitweise Exklusiv-Oder-Verknüpfung zwischen dem Akkumulator und der Zahl number durch und speichert das Ergebnis im Akkumulator.`,
        'en': `xor number: performs a bitwise exclusive OR operation between the accumulator and the number and stores the result in the accumulator.`,
        'fr': `xor nombre : effectue une opération OU exclusif binaire entre l'accumulateur et le nombre et stocke le résultat dans l'accumulateur.`
    });

        static CmpImmediate = () => lm({
        'de': `cmp zahl: subtrahiert die Zahl number vom Akkumulator (ohne diesen zu verändern!) und setzt die Flags entsprechend (zero, negative, overflow).`,
        'en': `cmp number: subtracts the number from the accumulator (without changing it!) and sets the flags accordingly (zero, negative, overflow).`,
        'fr': `cmp nombre : soustrait le nombre de l'accumulateur (sans le changer !) et définit les drapeaux en conséquence (zéro, négatif, dépassement).`
    });
